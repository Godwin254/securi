        ...
        <section className="section section__about">
            <div className="section__about__left-view">
...

                {
                     ...
                     * 
                     * <p className="section__about__left-view__text">
                        With Securi, estate owners and residents can enjoy a wide range of benefits. First, the application makes it easy to manage and monitor
                        vehicle usage within the estate, which helps to prevent unauthorized access and misuse of the vehicles. Additionally, the application 
                        provides a convenient way for residents to book and use the estate's vehicles, which helps to promote efficiency and reduce the need for 
                        individual car ownership. Finally, Securi's advanced security features help to ensure that the estate's vehicles are always secure and 
